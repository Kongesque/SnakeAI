  ...
  return (
    <main>
      <div className="flex flex-col items-center justify-center h-screen mx-auto max-w-2xl px-6">
        <h1 className="text-3xl sm:text-4xl font-bold xanh-mono-font mb-6">A Perfect Snake AI</h1>
        <SnakeGame />
        <p className="geist-mono-font text-center text-sm sm:text-base mt-6 mb-2">
