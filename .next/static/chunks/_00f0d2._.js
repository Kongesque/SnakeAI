(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_00f0d2._.js", {

"[project]/components/snake.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const SnakeGame = ()=>{
                ...
                "SnakeGame.useEffect.sketch": (p)=>{
                    ...
                    class HamiltonianCycle {
                        ...
                        createCycle(p) {
                            ...
                            var a = [];
                            let b = [];
                            for(a = 0; a < this.w; a++)for(var c = 0; c < this.h; c++)b.push(new HNode(a, c));
                            ...
                            for(a = 0; a < this.spanningTreeNodes.length; a++){
                                ...
                                for (var e of d.spanningTreeAdjacentNodes){
                                    c = ({
                                        "SnakeGame.useEffect.sketch": (p, t, q, u)=>{
                            ...
                            e = [];
                            for (var g of a)for (var h of a)if (p.dist(g.x, g.y, h.x, h.y) === 1 && Math.floor(g.x / 2) === Math.floor(h.x / 2) && Math.floor(g.y / 2) === Math.floor(h.y / 2)) {
                                f = new HEdge(h, g);
                                n = true;
                        ...
                        createSpanningTree(p) {
                            ...
                            for(; e.length < a.length;){
                                ...
                                d = c.edges.filter({
                                    "SnakeGame.useEffect.sketch": (f)=>!e.includes(f)
                                }["SnakeGame.useEffect.sketch"]);
                    ...
                    Array.prototype.getRandomElement = ({
                        "SnakeGame.useEffect.sketch": function() {
                    ...
                    class HPath {
                        ...
                        getSnakeTailPositionAfterFollowingPath(a) {
                            return this.pathLength - a.addCount < a.tailBlocks.length ? a.tailBlocks[Math.max(0, this.pathLength - a.addCount)] : this.nodesInPath[this.pathLength - a.addCount - a.tailBlocks.length];
                        }
                        getNextMove() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full aspect-[2.39/1] bg-[#202222] rounded-md border-[2px] border-[#3d3f40]",
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/components/snake.tsx",
            lineNumber: 530,
            columnNumber: 13
        }, this)
    }, void 0, false, {
...
//# sourceMappingURL=_00f0d2._.js.map